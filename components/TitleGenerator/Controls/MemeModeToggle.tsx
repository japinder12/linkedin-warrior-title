    ...
    <div className="min-w-[200px]">
      ...
      <div className="mt-2 flex items-center">
        <button
          ...
          className={`h-8 px-3 rounded-full border ${btnBd} text-xs inline-flex items-center gap-1 hover:bg-black/5 dark:hover:bg-white/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-40)] ${memeMode ? "bg-[var(--accent-10)] border-[var(--accent)] text-[var(--accent)] ring-2 ring-[var(--accent-40)]" : ""}`}
