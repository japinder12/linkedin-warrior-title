    ...
    <header className="relative mb-7">
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="max-w-2xl">
          ...
          <div
            className={[
              "mt-2 inline-flex items-center gap-2 rounded-full border px-5 py-2.5 shadow-sm shrink-0 ml-2 translate-y-[1px]",
              isDark
        ...
        <button
          className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 text-slate-700 dark:text-slate-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-40)] transition-colors"
      ...
      <p className={`mt-3 ${isDark ? "text-slate-300" : "text-slate-700"} text-[15px] md:text-base`}>
